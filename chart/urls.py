...
urlpatterns = [
    ...
    path('chart/index/',views.chart_index, name='chart_index'),
    path('chart/generate/',views.histories2edit, name='chart_generate'),
    path('chart/create/',views.none2edit, name='chart_create'),
    path('chart/add/',views.chart_add, name='chart_add'),
    path('chart/update/<int:id>',views.chart_update, name='chart_update'),
    path('chart/delete/<int:id>',views.chart_delete, name='chart_delete'),
    path('chart/detail/<int:id>',views.chart_detail, name='chart_detail'),
    path('chart/image/<int:id>',views.chart_image, name='chart_image'),
